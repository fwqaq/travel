	...
	export default {
		...
		data () {
			return {
				showGallary: false,
				imgs: [
				'http://img1.qunarzz.com/sight/p0/1708/2b/2b3b94de99c0a425a3.img.jpg_r_800x800_ae28174d.jpg',
				'http://img1.qunarzz.com/sight/p0/1908/e0/e0ee4f5e3ec59d14a3.img.jpg_r_800x800_fe02a2d6.jpg']
			}
		},
		methods: {
			handleBannerClick () {
